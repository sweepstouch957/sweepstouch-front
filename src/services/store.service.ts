...
export const getStoreByAddress = async (
  address: string
): Promise<Store[]> => {
...
export const getStoreByZipCode = async (
  zipCode: string
): Promise<Store[]> => {
...
export const getStoreByActive = async (
  active: boolean
): Promise<Store[]> => {
...
export const getStoreByCreatedAt = async (
  createdAt: string
): Promise<Store[]> => {
...
export const getStoreByUpdatedAt = async (
  updatedAt: string
): Promise<Store[]> => {
...
export const getStoreByImage = async (
  image: string
): Promise<Store[]> => {
...
export const getStoreByDescription = async (
  description: string
): Promise<Store[]> => {
...
export const getStoreByIdAndOwnerId = async (
  id: string,
  ownerId: string
): Promise<Store[]> => {
