...
// Usuario demo estático (no depende de estado del componente)
const user = {
...
export const Header: FC<HeaderProps> = (props) => {
  ...
  return (
    <HeaderWrapper
      ...
      role="banner"
      sx={{
        height: scroll === 'down' ? HEADER_HEIGHT * 1.2 : HEADER_HEIGHT * 1.5,
        width: {
          xs: '100%',
      ...
      >
        <Stack
          ...
          divider={
            <Divider
              sx={{
                borderColor: theme.palette.mode === 'dark' ? 'neutral.800' : 'neutral.500',
              }}
