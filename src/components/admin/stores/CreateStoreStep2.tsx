...
const tabletInventory: InventoryItem[] = [
  {
    id: 't9',
    label: 'Tablet 9" inch',
    description: 'Android, 64 GB, LTE',
    price: 200,
    image: '/images/devices/tablet-9.png',
  },
  {
    id: 't14',
    label: 'Tablet 14" inch',
    description: 'Android, 128 GB, LTE',
    price: 500,
    image: '/images/devices/tablet-14.png',
  },
];
...
const printerInventory: InventoryItem[] = [
  {
    ...
    description: 'USB/BT',
    price: 200,
    image: '/images/devices/printer-thermal.png',
  },
];
...
export default function CreateStoreStep2({
  ...
  /** ===== Sección B ===== */
  const [sectionB, setSectionB] = React.useState<BItem[]>(
    initialData?.sectionB ?? initialBItems,
  );

  const sectionBTotal = sectionB.reduce(
    (acc, it) => acc + (it.checked ? it.qty * it.price : 0),
    0,
  );
    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: 1 }}>
          ...
          >
            Selecciona la cantidad desde el inventario
          </Typography>
        </Box>
            ...
            {tabletInventory.map((it) => (
              ...
              >
                ...
                <IconButton
                  size="small"
                  onClick={() =>
                    changeQty(setTabletQty, tabletQty, it.id, -1)
                  }
                >
            ...
            {printerInventory.map((it) => (
              ...
              >
                ...
                <IconButton
                  size="small"
                  onClick={() =>
                    changeQty(setPrinterQty, printerQty, it.id, -1)
                  }
                >
                  <RemoveIcon fontSize="small" />
                </IconButton>
      ...
      <Box sx={{ mt: 0.75 }}>
        {sectionB.map((row, idx) => {
          ...
          const setQty = (next: number) =>
            setSectionB((prev) =>
              prev.map((r, i) =>
                i === idx ? { ...r, qty: next, checked: next > 0 } : r,
              ),
            );
          ...
          return (
            <Box
              ...
              sx={{
                ...
                gridTemplateColumns: {
                  xs: '1fr',
                  sm: 'minmax(170px,1.4fr) 140px 110px 130px 120px 120px',
                },
                gap: 1,
                alignItems: 'center',
                p: 1,
            ...
            >
              ...
              >
                ...
                <TextField
                  ...
                  value={row.qty}
                  onChange={(e) =>
                    setQty(Math.max(0, parseInt(e.target.value || '0', 10)))
                  }
